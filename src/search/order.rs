...
impl Search {
    pub(super) fn sort_moves(&mut self, moves: &Vec<Move>, board: &mut Board, depth: u8) -> Vec<(Move, f64)> {
    ...
    pub(super) fn evaluate_move(&mut self, m: Move, board: &mut Board, depth: u8) -> f64 {
